<?php exit;?>0014969002280a39488ec2197f4666e0acdc6cd2a97fs:3722:"a:2:{s:8:"template";s:3658:"<!DOCTYPE html>
<html lang="zh-cn">
<head>
    ...
    <div class="dux-head clearfix">
        <div class="dux-logo">
            <a href="http://www.duxcms.com" target="_blank">
                <img src="/yikaiba/public/lib/images/logo.png" alt="duxcms后台管理系统" />
            </a>
        ...
        <div class="dux-nav">
            ...
            <ul class="nav  nav-navicon nav-menu nav-inline admin-nav nav-tool">
               <li> <a href="/yikaiba/" target="_blank" class="icon-home"></a></li>
...
</html>";s:12:"compile_time";i:1465364228;}";
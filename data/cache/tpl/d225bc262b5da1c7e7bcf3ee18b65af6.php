        ...
        <div class="panel dux-box dux-dashboard">
            <div class="clearfix">
                <div class="media media-x ">
                    ...
                    <div class="media-body text-center">
                        <h2><strong><?php echo target('duxcms/Fragment')->countList(); ?></strong></h2>
                        碎片使用数量
                    </div>
                </div>
            </div>
                ...
                <table class="table">
                    <tbody>
                        <tr>
                            ...
                            <td><a href="http://<?php echo $_SERVER["SERVER_NAME"];?>" target="_blank">http://<?php echo $_SERVER["SERVER_NAME"];?>/yikaiba/</a>
                            </td>
                        </tr>
                        <tr>
